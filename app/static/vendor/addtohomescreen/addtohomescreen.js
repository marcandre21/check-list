...
Stripped by Alexandra Berke to have only what we're using
modifying browser history is incompatible with AngularJS
...
ath.defaults = {
	...
	// not using this or tokens because the cubiq way of doing this is incompatible with angularJS
